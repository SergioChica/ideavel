<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="text-center dark:bg-gray-800 rounded-md p-2 mb-4 ">
                <span class="text-white text-xl font-semibold">{{ session('message') }}</span>
            </div>
            @endif
            <div class="overflow-hidden shadow-sm sm:rounded-lg mb-4">
                <div class="p-6 text-gray-900 dark:text-gray-100s space-x-8">
                    <a href="{{route('ideas.create')}}" class="px-4 py-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-sm text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700">Agregar</a>
                    <a href="{{route('ideas.index', ['filters' => 'mis-ideas'])}}" class="px-4 py-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-sm text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700">Mis ideas</a>
                    <a href="{{route('ideas.index', ['filters' => 'las-mejores'])}}" class="px-4 py-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md font-semibold text-sm text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700">Las Mejores</a>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg ">
                ...
                <div class="p-6 flex space-x-2">
                    ...
                    <div class="flex-1 ml-3">
                        <div class="flex justify-between items-center">
                            ...
                            @auth
                                <x-dropdown>
                                    ...
                                    <x-slot name="content">
                                        <x-dropdown-link :href="route('ideas.show', $idea)">
                                            Ver
                                        </x-dropdown-link>
                                        @can('update', $idea)
                                        <x-dropdown-link :href="route('ideas.edit', $idea->id)">
                                            Editar
                                        </x-dropdown-link>
                                        <form method="POST" action="{{ route('ideas.delete', $idea) }}">
                                            @csrf
                                            @method('delete')
                        ...
                        <small class="text-sm text-gray-400 flex items-center gap-2 mt-3 ">
                            ...
                            <span class="pl-2 ">{{ $idea->likes}}</span>
                        </small>
                    </div>
                </div>
